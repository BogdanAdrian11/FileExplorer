...
public class CutSelectionListener implements SelectionListener {
	 ...
	 * @param pasteItem
	 */
	public CutSelectionListener(TableViewer tableViewer, List<String> history, Shell shell,
	...
	public void widgetSelected(SelectionEvent e) {
		...
		for (int index : indices) {
			tableViewer.getTable().getItem(index).setFont(
